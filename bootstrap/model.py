...
This is currently a small placeholder architecture (enough to prove the
export/loading path end-to-end -- see export/to_tflite.py), not tuned for
actual training quality. Revisit the architecture once Phase 2's imitation
learning loop needs it to actually learn something.
"""
...
class RayZeroNet(nn.Module):
    ...
    def __init__(self, board_size: int = 9, channels: int = 32) -> None:
        super().__init__()
